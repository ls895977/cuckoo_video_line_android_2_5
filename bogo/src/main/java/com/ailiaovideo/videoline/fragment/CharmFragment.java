...
import com.ailiaovideo.videoline.adapter.recycler.RecyclerRankingAdapter;
...
import com.ailiaovideo.videoline.json.JsonRequestRank;
import com.ailiaovideo.videoline.modle.RankModel;
...
public class CharmFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void initView(View view) {
        ...
        if (headView == null) {
            //引入头部信息
            headView = LayoutInflater.from(getContext()).inflate(R.layout.view_ranking_one, null);
