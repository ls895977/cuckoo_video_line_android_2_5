...
import com.ailiaovideo.videoline.audiorecord.IRecordAudioListener;
import com.ailiaovideo.videoline.audiorecord.entity.EnterRecordAudioEntity;
import com.ailiaovideo.videoline.audiorecord.util.Cons;
import com.ailiaovideo.videoline.audiorecord.util.PaoPaoTips;
import com.ailiaovideo.videoline.audiorecord.util.PermissionUtil;
import com.ailiaovideo.videoline.audiorecord.util.StringUtil;
import com.ailiaovideo.videoline.audiorecord.view.LineWaveVoiceView;
import com.ailiaovideo.videoline.audiorecord.view.RecordAudioView;
...
public class AudioRecordActivity extends FragmentActivity implements
    ...
    public String onRecordStart() {
        ...
        audioFileName = MyApplication.getInstances().getExternalCacheDir() + File.separator + createAudioName();
