package com.ailiaovideo.video.videoupload.impl;
...
public class TVCClient {
     ...
     * @param iTimeOut  超时时间
     */
    public TVCClient(Context context, String customKey, String signature, String cosRegion, boolean enableResume, int iTimeOut) {
     ...
     */
    public TVCClient(Context context, String customKey, String ugcSignature, String cosRegion, boolean resumeUpload) {
    ...
    private void parseInitRsp(String rspString) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(uploadRegion))
                uploadRegion = dataObj.optString("StorageRegionV5", Region.AP_Guangzhou_2.getRegion());
