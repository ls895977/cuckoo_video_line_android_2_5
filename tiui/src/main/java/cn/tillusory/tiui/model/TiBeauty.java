...
public enum TiBeauty {
    ...
    BRIGHTNESS(cn.tillusory.sdk.R.string.skin_brightness, R.drawable.ic_ti_saturation),
    TENDERNESS(cn.tillusory.sdk.R.string.skin_tenderness, R.drawable.ic_ti_tenderness),
    SATURATION(cn.tillusory.sdk.R.string.skin_saturation, R.drawable.ic_ti_saturation);
