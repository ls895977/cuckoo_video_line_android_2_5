...
public class TiBeautyView extends LinearLayout {
    ...
    private void initData() {
        ...
        tiTabs.add(getResources().getString(R.string.gift));
        tiTabs.add(getResources().getString(R.string.filter));
        tiTabs.add(getResources().getString(R.string.rock));
        tiTabs.add(getResources().getString(R.string.distortion));
        tiTabs.add(getResources().getString(R.string.watermark));
                ...
                new IndicatorViewPager.IndicatorFragmentPagerAdapter(((FragmentActivity) getContext()).getSupportFragmentManager()) {
                    ...
                    public Fragment getFragmentForPage(int position) {
                        switch (position) {
                            ...
                            case 4://滤镜
                                return new TiFilterFragment().setTiSDKManager(tiSDKManager);
                            case 5://抖音
    ...
    public void setSelectAction(String selectAction) {
        ...
        switch (selectAction) {
            ...
            case RxBusAction.ACTION_SKIN_BRIGHTNESS:
                tiNumberTV.setText(new StringBuilder().append(tiSDKManager.getSkinBrightness()));
                tiSeekBar.setProgress(tiSDKManager.getSkinBrightness());
    ...
    private class TiOnSeekBarChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(final SeekBar seekBar, final int progress, boolean fromUser) {
            ...
            switch (selectAction) {
                ...
                case RxBusAction.ACTION_SKIN_BRIGHTNESS:
                    tiNumberTV.setText(new StringBuilder().append(progress));
                    tiSDKManager.setSkinBrightness(progress);
                    break;
                case RxBusAction.ACTION_EYE_MAGNIFYING:
                    tiNumberTV.setText(new StringBuilder().append(progress));
